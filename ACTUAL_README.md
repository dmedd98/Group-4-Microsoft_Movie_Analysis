...
See the full analysis in the [Jupyter Notebook](./notebooks/Cleaned_December_Movie_Launch.ipynb) or review this [presentation](./Group_ 4_Microsoft_Movie_Analysis/Group_ 4_Microsoft_Movie_Analysis.pdf).
